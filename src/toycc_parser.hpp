...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // opt_arg_list
      // arg_list
      char dummy11[sizeof (std::vector<std::shared_ptr<toycc::Expr>>)];

      // opt_param_list
      // param_list
      char dummy12[sizeof (std::vector<std::shared_ptr<toycc::FuncParam>>)];

      // stmt_list
      char dummy13[sizeof (std::vector<std::shared_ptr<toycc::Stmt>>)];

      // decl_specifier
      char dummy14[sizeof (toycc::DeclSpec)];
    };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_OR = 33,                               // OR
        S_NOT = 34,                              // NOT
        S_INVALID = 35,                          // INVALID
        S_END = 36,                              // END
        S_YYACCEPT = 37,                         // $accept
        S_compilation_unit = 38,                 // compilation_unit
        S_global_decl_list = 39,                 // global_decl_list
        S_global_decl = 40,                      // global_decl
        S_func_def = 41,                         // func_def
        S_opt_param_list = 42,                   // opt_param_list
        S_param_list = 43,                       // param_list
        S_param = 44,                            // param
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_primary_expr: // primary_expr
        value.move< std::shared_ptr<toycc::Expr> > (std::move (that.value));
        break;

      case symbol_kind::S_func_def: // func_def
        value.move< std::shared_ptr<toycc::FuncDef> > (std::move (that.value));
        break;

      case symbol_kind::S_param: // param
        value.move< std::shared_ptr<toycc::FuncParam> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_continue_stmt: // continue_stmt
        value.move< std::shared_ptr<toycc::Stmt> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_arg_list: // arg_list
        value.move< std::vector<std::shared_ptr<toycc::Expr>> > (std::move (that.value));
        break;

      case symbol_kind::S_opt_param_list: // opt_param_list
      case symbol_kind::S_param_list: // param_list
        value.move< std::vector<std::shared_ptr<toycc::FuncParam>> > (std::move (that.value));
        break;

      case symbol_kind::S_stmt_list: // stmt_list
        value.move< std::vector<std::shared_ptr<toycc::Stmt>> > (std::move (that.value));
        break;

      case symbol_kind::S_decl_specifier: // decl_specifier
        value.move< toycc::DeclSpec > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<toycc::Block>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<toycc::Block>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<toycc::Decl>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<toycc::Decl>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<toycc::Expr>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<toycc::Expr>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<toycc::FuncDef>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<toycc::FuncDef>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<toycc::FuncParam>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<toycc::FuncParam>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<toycc::Stmt>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<toycc::Stmt>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::shared_ptr<toycc::ASTNode>>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::shared_ptr<toycc::ASTNode>>& v)
        : Base (t)
        , value (v)
      {}
#endif
      ...
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::shared_ptr<toycc::Expr>>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::shared_ptr<toycc::FuncParam>>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::shared_ptr<toycc::FuncParam>>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::shared_ptr<toycc::Stmt>>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::shared_ptr<toycc::Stmt>>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, toycc::DeclSpec&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const toycc::DeclSpec& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yykind)
    {
      ...
      case symbol_kind::S_unary_expr: // unary_expr
      case symbol_kind::S_primary_expr: // primary_expr
        value.template destroy< std::shared_ptr<toycc::Expr> > ();
        break;

      case symbol_kind::S_func_def: // func_def
        value.template destroy< std::shared_ptr<toycc::FuncDef> > ();
        break;

      case symbol_kind::S_param: // param
        value.template destroy< std::shared_ptr<toycc::FuncParam> > ();
        break;
      ...
      case symbol_kind::S_break_stmt: // break_stmt
      case symbol_kind::S_continue_stmt: // continue_stmt
        value.template destroy< std::shared_ptr<toycc::Stmt> > ();
        break;
      ...
      case symbol_kind::S_opt_arg_list: // opt_arg_list
      case symbol_kind::S_arg_list: // arg_list
        value.template destroy< std::vector<std::shared_ptr<toycc::Expr>> > ();
        break;

      case symbol_kind::S_opt_param_list: // opt_param_list
      case symbol_kind::S_param_list: // param_list
        value.template destroy< std::vector<std::shared_ptr<toycc::FuncParam>> > ();
        break;

      case symbol_kind::S_stmt_list: // stmt_list
        value.template destroy< std::vector<std::shared_ptr<toycc::Stmt>> > ();
        break;

      case symbol_kind::S_decl_specifier: // decl_specifier
        value.template destroy< toycc::DeclSpec > ();
        break;
    ...
    parser (toycc::ParserDriver& driver_yyarg);
    virtual ~parser ();
    ...
    , value ()
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_unary_expr: // unary_expr
      case symbol_kind::S_primary_expr: // primary_expr
        value.copy< std::shared_ptr<toycc::Expr> > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_func_def: // func_def
        value.copy< std::shared_ptr<toycc::FuncDef> > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_param: // param
        value.copy< std::shared_ptr<toycc::FuncParam> > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_break_stmt: // break_stmt
      case symbol_kind::S_continue_stmt: // continue_stmt
        value.copy< std::shared_ptr<toycc::Stmt> > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_opt_arg_list: // opt_arg_list
      case symbol_kind::S_arg_list: // arg_list
        value.copy< std::vector<std::shared_ptr<toycc::Expr>> > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_opt_param_list: // opt_param_list
      case symbol_kind::S_param_list: // param_list
        value.copy< std::vector<std::shared_ptr<toycc::FuncParam>> > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_stmt_list: // stmt_list
        value.copy< std::vector<std::shared_ptr<toycc::Stmt>> > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_decl_specifier: // decl_specifier
        value.copy< toycc::DeclSpec > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_unary_expr: // unary_expr
      case symbol_kind::S_primary_expr: // primary_expr
        value.move< std::shared_ptr<toycc::Expr> > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_func_def: // func_def
        value.move< std::shared_ptr<toycc::FuncDef> > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_param: // param
        value.move< std::shared_ptr<toycc::FuncParam> > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_break_stmt: // break_stmt
      case symbol_kind::S_continue_stmt: // continue_stmt
        value.move< std::shared_ptr<toycc::Stmt> > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_opt_arg_list: // opt_arg_list
      case symbol_kind::S_arg_list: // arg_list
        value.move< std::vector<std::shared_ptr<toycc::Expr>> > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_opt_param_list: // opt_param_list
      case symbol_kind::S_param_list: // param_list
        value.move< std::vector<std::shared_ptr<toycc::FuncParam>> > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_stmt_list: // stmt_list
        value.move< std::vector<std::shared_ptr<toycc::Stmt>> > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_decl_specifier: // decl_specifier
        value.move< toycc::DeclSpec > (YY_MOVE (s.value));
        break;
