// Matrix-style scalar kernel: nine loop-carried values and nine simultaneous
// next-state temporaries.  This approximates the register pressure of the
// advanced matrix category without relying on hidden test sources.
int main() {
  int a00 = 1;
  int a01 = 2;
  int a02 = 3;
