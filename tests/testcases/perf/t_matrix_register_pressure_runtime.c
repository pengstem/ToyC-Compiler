// Keep the scalar matrix kernel at runtime so the register-coloring regression
// remains independent of the modular loop summarizer.  A negative initial
// state deliberately makes C remainder differ from mathematical modulo.
int main() {
  int a00 = -1;
  int a01 = 2;
  int a02 = 3;
